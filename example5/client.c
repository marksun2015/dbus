...
static gboolean test_status_handler(helloTest *object, gint value, gpointer userdata) 
{ 
...
{ 
    ...
    proxy = hello_test_proxy_new_sync(conn,G_DBUS_PROXY_FLAGS_NONE,"com.yft.hello","/com/yft/hello",NULL,&proxyerror); 
