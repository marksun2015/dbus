...
void hello_test_complete_browser_ready (
    helloTest *object,
    GDBusMethodInvocation *invocation,
    gint response);
...
void hello_test_emit_test_hihi (
    helloTest *object,
    const gchar *arg_hihi);
...
void hello_test_call_browser_ready (
    helloTest *proxy,
    const gchar *arg_greeting,
    GCancellable *cancellable,
    GAsyncReadyCallback callback,
...
gboolean hello_test_call_browser_ready_finish (
    helloTest *proxy,
    gint *out_response,
    GAsyncResult *res,
    GError **error);

gboolean hello_test_call_browser_ready_sync (
    helloTest *proxy,
    const gchar *arg_greeting,
    gint *out_response,
    GCancellable *cancellable,
