/*
 * Generated by gdbus-codegen 2.62.4 from hello.xml. DO NOT EDIT.
 *
...
static const _ExtendedGDBusArgInfo _hello_test_method_info_browser_ready_IN_ARG_greeting =
{
  {
    -1,
    (gchar *) "greeting",
...
static const GDBusArgInfo * const _hello_test_method_info_browser_ready_IN_ARG_pointers[] =
{
  &_hello_test_method_info_browser_ready_IN_ARG_greeting.parent_struct,
  NULL
};

static const _ExtendedGDBusArgInfo _hello_test_method_info_browser_ready_OUT_ARG_response =
{
  {
    -1,
    (gchar *) "response",
...
static const GDBusArgInfo * const _hello_test_method_info_browser_ready_OUT_ARG_pointers[] =
{
  &_hello_test_method_info_browser_ready_OUT_ARG_response.parent_struct,
  NULL
};

static const _ExtendedGDBusMethodInfo _hello_test_method_info_browser_ready =
{
  {
    -1,
    (gchar *) "browserReady",
    (GDBusArgInfo **) &_hello_test_method_info_browser_ready_IN_ARG_pointers,
    (GDBusArgInfo **) &_hello_test_method_info_browser_ready_OUT_ARG_pointers,
    NULL
  },
  "handle-browser-ready",
  FALSE
};
...
static const GDBusMethodInfo * const _hello_test_method_info_pointers[] =
{
  ...
  &_hello_test_method_info_browser_ready.parent_struct,
  NULL
};
...
static const _ExtendedGDBusArgInfo _hello_test_signal_info_test_hihi_ARG_hihi =
{
  {
    -1,
    (gchar *) "hihi",
...
static const GDBusArgInfo * const _hello_test_signal_info_test_hihi_ARG_pointers[] =
{
  &_hello_test_signal_info_test_hihi_ARG_hihi.parent_struct,
  NULL
};

static const _ExtendedGDBusSignalInfo _hello_test_signal_info_test_hihi =
{
  {
    -1,
    (gchar *) "testHihi",
    (GDBusArgInfo **) &_hello_test_signal_info_test_hihi_ARG_pointers,
    NULL
  },
  "test-hihi"
};
...
static const GDBusSignalInfo * const _hello_test_signal_info_pointers[] =
{
  ...
  &_hello_test_signal_info_test_hihi.parent_struct,
  NULL
};
 ...
 * @handle_browser_ready: Handler for the #helloTest::handle-browser-ready signal.
 * @handle_set_version: Handler for the #helloTest::handle-set-version signal.
 * @test_hihi: Handler for the #helloTest::test-hihi signal.
...
hello_test_default_init (helloTestIface *iface)
{
  ...
  /**
   * helloTest::handle-browser-ready:
   * @object: A #helloTest.
   * @invocation: A #GDBusMethodInvocation.
   * @arg_greeting: Argument passed by remote caller.
   *
   * Signal emitted when a remote caller is invoking the <link linkend="gdbus-method-com-yft-hello-test.browserReady">browserReady()</link> D-Bus method.
   *
   * If a signal handler returns %TRUE, it means the signal handler will handle the invocation (e.g. take a reference to @invocation and eventually call hello_test_complete_browser_ready() or e.g. g_dbus_method_invocation_return_error() on it) and no order signal handlers will run. If no signal handler handles the invocation, the %G_DBUS_ERROR_UNKNOWN_METHOD error is returned.
   *
   * Returns: %TRUE if the invocation was handled, %FALSE to let other signal handlers run.
   */
  g_signal_new ("handle-browser-ready",
    G_TYPE_FROM_INTERFACE (iface),
    G_SIGNAL_RUN_LAST,
    G_STRUCT_OFFSET (helloTestIface, handle_browser_ready),
    g_signal_accumulator_true_handled,
    NULL,
    g_cclosure_marshal_generic,
    G_TYPE_BOOLEAN,
   ...
   * @arg_hihi: Argument.
   *
   * On the client-side, this signal is emitted whenever the D-Bus signal <link linkend="gdbus-signal-com-yft-hello-test.testHihi">"testHihi"</link> is received.
   *
   * On the service-side, this signal can be used with e.g. g_signal_emit_by_name() to make the object emit the D-Bus signal.
   */
  g_signal_new ("test-hihi",
    G_TYPE_FROM_INTERFACE (iface),
    G_SIGNAL_RUN_LAST,
    G_STRUCT_OFFSET (helloTestIface, test_hihi),
    NULL,
    NULL,
    g_cclosure_marshal_generic,
    G_TYPE_NONE,
...
/**
 * hello_test_emit_test_hihi:
 * @object: A #helloTest.
 * @arg_hihi: Argument to pass with the signal.
 *
 * Emits the <link linkend="gdbus-signal-com-yft-hello-test.testHihi">"testHihi"</link> D-Bus signal.
 */
void
hello_test_emit_test_hihi (
    helloTest *object,
    const gchar *arg_hihi)
{
  g_signal_emit_by_name (object, "test-hihi", arg_hihi);
}
 ...
 * @user_data: User data to pass to @callback.
 *
 * Asynchronously invokes the <link linkend="gdbus-method-com-yft-hello-test.browserReady">browserReady()</link> D-Bus method on @proxy.
 * When the operation is finished, @callback will be invoked in the <link linkend="g-main-context-push-thread-default">thread-default main loop</link> of the thread you are calling this method from.
 * You can then call hello_test_call_browser_ready_finish() to get the result of the operation.
 *
 * See hello_test_call_browser_ready_sync() for the synchronous, blocking version of this method.
 */
void
hello_test_call_browser_ready (
    helloTest *proxy,
...
/**
 * hello_test_call_browser_ready_finish:
 * @proxy: A #helloTestProxy.
 * @out_response: (out) (optional): Return location for return parameter or %NULL to ignore.
 * @res: The #GAsyncResult obtained from the #GAsyncReadyCallback passed to hello_test_call_browser_ready().
 * @error: Return location for error or %NULL.
 *
 * Finishes an operation started with hello_test_call_browser_ready().
 *
 * Returns: (skip): %TRUE if the call succeded, %FALSE if @error is set.
 */
gboolean
...
/**
 * hello_test_call_browser_ready_sync:
 * @proxy: A #helloTestProxy.
 * @arg_greeting: Argument to pass with the method invocation.
 * @out_response: (out) (optional): Return location for return parameter or %NULL to ignore.
 * @cancellable: (nullable): A #GCancellable or %NULL.
 * @error: Return location for error or %NULL.
 *
 * Synchronously invokes the <link linkend="gdbus-method-com-yft-hello-test.browserReady">browserReady()</link> D-Bus method on @proxy. The calling thread is blocked until a reply is received.
 *
 * See hello_test_call_browser_ready() for the asynchronous version of this method.
 *
 * Returns: (skip): %TRUE if the call succeded, %FALSE if @error is set.
 */
gboolean
...
/**
 * hello_test_complete_browser_ready:
 * @object: A #helloTest.
 * @invocation: (transfer full): A #GDBusMethodInvocation.
 * @response: Parameter to return.
 *
 * Helper function used in service implementations to finish handling invocations of the <link linkend="gdbus-method-com-yft-hello-test.browserReady">browserReady()</link> D-Bus method. If you instead want to finish handling an invocation by returning an error, use g_dbus_method_invocation_return_error() or similar.
 *
 * This method will free @invocation, you cannot use it afterwards.
 */
void
...
static void
_hello_test_on_signal_test_hihi (
    helloTest *object,
    const gchar *arg_hihi)
{
  helloTestSkeleton *skeleton = HELLO_TEST_SKELETON (object);
  ...
  for (l = connections; l != NULL; l = l->next)
    {
      GDBusConnection *connection = l->data;
      g_dbus_connection_emit_signal (connection,
        NULL, g_dbus_interface_skeleton_get_object_path (G_DBUS_INTERFACE_SKELETON (skeleton)), "com.yft.hello.test", "testHihi",
        signal_variant, NULL);
    }
  g_variant_unref (signal_variant);
  g_list_free_full (connections, g_object_unref);
...
hello_test_skeleton_iface_init (helloTestIface *iface)
{
  ...
  iface->test_hihi = _hello_test_on_signal_test_hihi;
}
